...
import { Bell, Globe2, KeyRound, Mail, MapPin, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="space-y-stack-lg animate-in fade-in duration-500">
      <div>
        ...
        <p className="font-body-md text-on-surface-variant">Edit operational configuration for storefront, support, and verification workflows.</p>
      </div>
      ...
      <form onSubmit={handleSaveSettings} className="grid grid-cols-1 gap-gutter lg:grid-cols-2">
        {settingFields.map((item) => {
          const Icon = item.icon;
          return (
            <section key={item.key} className="border border-surface-container-highest bg-charcoal-field p-stack-md">
        ...
        <section className="border border-surface-container-highest bg-charcoal-field p-stack-md lg:col-span-2">
          <div className="mb-stack-md flex items-start justify-between gap-4">
            <div>
              <h2 className="font-headline-md text-headline-md uppercase text-stark-white">Admin Access</h2>
              <p className="mt-2 font-body-md text-on-surface-variant">Password-protected admin sessions are enforced before operational pages load.</p>
            </div>
            <div className="border border-signal-orange/50 bg-tactical-black p-3 text-signal-orange">
        ...
        <div className="lg:col-span-2 flex justify-end">
          <button type="submit" disabled={saving || loading} className="bg-signal-orange px-5 py-3 font-label-caps text-tactical-black hover:bg-stark-white disabled:opacity-60">
