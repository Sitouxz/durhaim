...
assert.equal(QR_LABEL_MARGIN_MM, 0.5);
assert.equal(QR_LABEL_GAP_MM, 0.5);
assert.equal(QR_LABEL_PADDING_MM, 0.25);
...
console.log(
  "QR export layout uses flexible pages, square cells, equal padding, gaps, and outer margins.",
);
